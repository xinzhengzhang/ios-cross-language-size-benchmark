...
- (void)runBenchmark;
- (void)processUserWorkflowAtIndex:(NSInteger)index;
- (void)processProductWorkflowAtIndex:(NSInteger)index;
- (void)processOrderWorkflowAtIndex:(NSInteger)index;
- (void)processReviewWorkflowAtIndex:(NSInteger)index;
- (void)processCategoryWorkflowAtIndex:(NSInteger)index;
- (void)processInventoryWorkflowAtIndex:(NSInteger)index;
- (void)processPaymentWorkflowAtIndex:(NSInteger)index;
- (void)processShippingWorkflowAtIndex:(NSInteger)index;
- (void)processNotificationWorkflowAtIndex:(NSInteger)index;
- (void)processAnalyticsWorkflowAtIndex:(NSInteger)index;
@end
...
- (void)runBenchmark {
    for (NSInteger index = 1; index <= 100; index++) {
        [self processUserWorkflowAtIndex:index];
        [self processProductWorkflowAtIndex:index];
        [self processOrderWorkflowAtIndex:index];
        [self processReviewWorkflowAtIndex:index];
        [self processCategoryWorkflowAtIndex:index];
        [self processInventoryWorkflowAtIndex:index];
        [self processPaymentWorkflowAtIndex:index];
        [self processShippingWorkflowAtIndex:index];
        [self processNotificationWorkflowAtIndex:index];
        [self processAnalyticsWorkflowAtIndex:index];
    }
}
